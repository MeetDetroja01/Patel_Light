    ...
    <>
                    ...
                    <li key={s}>
                      <button
                        ...
                        className={`w-full text-left px-4 py-2 text-sm transition-colors
                          ${stateValue === s
                            ? "bg-red-50 text-[#Fd0304] font-semibold"
      ...
      <div>
        ...
        {customCity ? (
          ...
          <div className="input-base flex items-center gap-2 text-slate-400 cursor-not-allowed select-none"
                ...
                <div className="border-t border-slate-100 p-2">
                  <button
                    ...
                    onClick={() => {
                      setCustomCity(true);
                      setCityOpen(false);
                      if (citySearch) onCityChange(citySearch);
                    }}
                    className="w-full text-left px-3 py-2 text-xs font-semibold text-[#Fd0304] hover:bg-red-50 rounded-lg transition-colors flex items-center gap-2"
                  >
                    <svg className="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
